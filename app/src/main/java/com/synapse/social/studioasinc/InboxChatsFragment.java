	...
	public class InboxListRecyclerViewAdapter extends RecyclerView.Adapter<InboxListRecyclerViewAdapter.ViewHolder> {
		...
		public void onBindViewHolder(ViewHolder _holder, final int _position) {
			...
			try{
				...
				userStatusCircleIN.setBackground(createRoundedDrawable(300, getThemeColor(com.google.android.material.R.attr.colorPrimary)));
				unread_messages_count_badge.setBackground(createRoundedDrawable(300, getThemeColor(com.google.android.material.R.attr.colorPrimaryContainer)));
									...
									public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
										mMainHandler.post(new Runnable() {
											...
											public void run() {
												...
												if(dataSnapshot.exists()) {
													last_message.setTextColor(getThemeColor(com.google.android.material.R.attr.colorOnSurface));
													push.setTextColor(getThemeColor(com.google.android.material.R.attr.colorOnSurface));
													...
													last_message.setTextColor(getThemeColor(com.google.android.material.R.attr.colorOnSurfaceVariant));
													push.setTextColor(getThemeColor(com.google.android.material.R.attr.colorOnSurfaceVariant));
													unread_messages_count_badge.setVisibility(View.GONE);
												}
											}
										});
