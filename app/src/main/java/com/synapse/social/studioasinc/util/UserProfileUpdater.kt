...
class UserProfileUpdater(
    ...
    fun updateAll(data: Map<String, Any>) {
    ...
    private fun updateUserProfile(data: Map<String, Any>) {
        if ("true" == data["banned"]) {
            ...
            val avatarUrl = data["avatar"] as? String
    ...
    private fun updateUserBadges(data: Map<String, Any>) {
        ...
        val badgeRes = when (accountType) {
            ...
            "support" -> R.drawable.support_badge
                ...
                when {
                    "true" == data["account_premium"] -> R.drawable.premium_badge
                    "true" == data["verify"] -> R.drawable.verified_badge
                    else -> 0
                }
            }
        }
