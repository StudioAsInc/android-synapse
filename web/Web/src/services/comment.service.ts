...
export class CommentService {
  ...
  async createComment(postId: string, content: string, parentId?: string, mediaUrl?: string) {
  ...
  async addCommentReaction(commentId: string, userId: string, reactionType: string) {
    try {
      ...
      await this.supabase.rpc('increment_comment_likes', { comment_id: commentId });
    } catch (err) {
  ...
  async removeCommentReaction(commentId: string, userId: string) {
    try {
      ...
      await this.supabase.rpc('decrement_comment_likes', { comment_id: commentId });
    } catch (err) {
