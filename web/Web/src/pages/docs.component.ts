            ...
            @case ('api') {
              <article class="prose dark:prose-invert max-w-none">
                <div class="flex items-center gap-3 mb-6">
                   ...
                   <h1 class="text-4xl font-bold text-slate-900 dark:text-white m-0">API Documentation</h1>
                </div>
                
                <p class="text-lg text-slate-600 dark:text-slate-400 mb-8">
                   Synapse uses Supabase REST API for all backend operations. All endpoints require authentication via API keys.
                </p>
                ...
                <div class="rounded-xl bg-slate-900 p-6 mb-8">
                   <pre class="text-sm font-mono text-slate-300"><code>Authorization: Bearer YOUR_API_KEY
apikey: YOUR_API_KEY</code></pre>
                ...
                <div class="space-y-6 mb-12">
                   <div class="border rounded-lg overflow-hidden border-slate-200 dark:border-white/10">
                      <div class="bg-slate-50 dark:bg-slate-900/50 px-4 py-3 border-b border-slate-200 dark:border-white/10 flex items-center gap-3">
                         <span class="px-2 py-1 rounded bg-green-500/10 text-green-600 dark:text-green-400 text-xs font-bold">GET</span>
                         <code class="text-sm font-mono text-slate-700 dark:text-slate-300">/rest/v1/posts</code>
                      </div>
                      <div class="p-4 bg-white dark:bg-slate-950 text-slate-600 dark:text-slate-400 text-sm">
                         Fetch posts from the feed. Supports filtering by user_id, ordering, and pagination.
                      </div>
                   </div>

                   <div class="border rounded-lg overflow-hidden border-slate-200 dark:border-white/10">
                      <div class="bg-slate-50 dark:bg-slate-900/50 px-4 py-3 border-b border-slate-200 dark:border-white/10 flex items-center gap-3">
                         <span class="px-2 py-1 rounded bg-blue-500/10 text-blue-600 dark:text-blue-400 text-xs font-bold">POST</span>
                         <code class="text-sm font-mono text-slate-700 dark:text-slate-300">/rest/v1/posts</code>
                      </div>
                      <div class="p-4 bg-white dark:bg-slate-950 text-slate-600 dark:text-slate-400 text-sm">
                         Create a new post. Requires content, user_id in request body.
                      </div>
                   </div>
                   ...
                   <div class="border rounded-lg overflow-hidden border-slate-200 dark:border-white/10">
                      <div class="bg-slate-50 dark:bg-slate-900/50 px-4 py-3 border-b border-slate-200 dark:border-white/10 flex items-center gap-3">
                         <span class="px-2 py-1 rounded bg-green-500/10 text-green-600 dark:text-green-400 text-xs font-bold">GET</span>
                         <code class="text-sm font-mono text-slate-700 dark:text-slate-300">/rest/v1/users</code>
                      </div>
                      <div class="p-4 bg-white dark:bg-slate-950 text-slate-600 dark:text-slate-400 text-sm">
                         Get user profiles. Filter by username or id.
                      </div>
                   </div>
                   ...
                   <div class="border rounded-lg overflow-hidden border-slate-200 dark:border-white/10">
                      <div class="bg-slate-50 dark:bg-slate-900/50 px-4 py-3 border-b border-slate-200 dark:border-white/10 flex items-center gap-3">
                         <span class="px-2 py-1 rounded bg-blue-500/10 text-blue-600 dark:text-blue-400 text-xs font-bold">POST</span>
                         <code class="text-sm font-mono text-slate-700 dark:text-slate-300">/rest/v1/likes</code>
                      </div>
                      <div class="p-4 bg-white dark:bg-slate-950 text-slate-600 dark:text-slate-400 text-sm">
                         Like a post. Requires post_id and user_id.
                      </div>
                   </div>

                   <div class="border rounded-lg overflow-hidden border-slate-200 dark:border-white/10">
                      <div class="bg-slate-50 dark:bg-slate-900/50 px-4 py-3 border-b border-slate-200 dark:border-white/10 flex items-center gap-3">
                         <span class="px-2 py-1 rounded bg-red-500/10 text-red-600 dark:text-red-400 text-xs font-bold">DELETE</span>
                         <code class="text-sm font-mono text-slate-700 dark:text-slate-300">/rest/v1/likes</code>
                      </div>
                      <div class="p-4 bg-white dark:bg-slate-950 text-slate-600 dark:text-slate-400 text-sm">
                         Unlike a post. Filter by post_id and user_id.
                      </div>
                   </div>
                   ...
                   <div class="border rounded-lg overflow-hidden border-slate-200 dark:border-white/10">
                      <div class="bg-slate-50 dark:bg-slate-900/50 px-4 py-3 border-b border-slate-200 dark:border-white/10 flex items-center gap-3">
                         <span class="px-2 py-1 rounded bg-green-500/10 text-green-600 dark:text-green-400 text-xs font-bold">GET</span>
                         <code class="text-sm font-mono text-slate-700 dark:text-slate-300">/rest/v1/follows</code>
                      </div>
                      <div class="p-4 bg-white dark:bg-slate-950 text-slate-600 dark:text-slate-400 text-sm">
                         Get follow relationships. Filter by follower_id or following_id.
                      </div>
                   </div>
                </div>
                ...
                <p class="text-slate-600 dark:text-slate-400 mb-4">
                   Free tier: 500 requests/hour. Pro tier: 5000 requests/hour.
                </p>

                <div class="p-6 rounded-xl bg-blue-50 border border-blue-100 text-blue-800 dark:bg-blue-500/10 dark:border-blue-500/20 dark:text-blue-200">
                   <strong>Tip:</strong> Generate your API keys in <a routerLink="/app/settings/api-keys" class="underline">Settings → API Keys</a>
                </div>
              </article>
            }
